...
const ContactSection = () => {
  return (
    <>
      <Helmet>
        <title>Contact Us | Hameau des Jeunes - ETSK Musha School</title>
        <meta
          name="description"
          content="Get in touch with Hameau des Jeunes at ETSK Musha School. Reach out via phone, email, or visit us in Bicumbi. We welcome your questions and support."
        />
        <meta
          name="keywords"
          content="contact hameau des jeunes, etsk musha contact, phone number, email, location, bicumbi"
        />
